...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div style="margin: 50px;">
            ...
            <!-- Report Name -->
            <h2 style="color: #001529; line-height: 1px; margin-top: 50px;">Doctor Report</h2>
            ...
            <!-- Registered Doctor --------------------------------------------->
            <h3 style="line-height: 1px; margin-top: 40px;">Registered Doctor</h3>
            ...
            <table id="reporttable" style="margin-top: 10px;">
                ...
                @foreach ($doctor_dates as $key => $doctor)
                <tr>
                    <td>{{$key}}</td>
                    <td>{{count($doctor)}}</td>
                </tr>
            ...
            <!-- Appointed dates --------------------------------------------->
            <h3 style="line-height: 1px; margin-top: 40px;">Appointment Date</h3>
            ...
            <table id="reporttable" style="margin-top: 10px;">
                ...
                @foreach ($appointment_doctor_dates as $key => $doctor)
                <tr>
                    <td>{{$key}}</td>
                    <td>{{count($doctor)}}</td>
                </tr>
            ...
            <table id="reporttable" style="margin-top: 10px;">
                ...
                <tr><td colspan="2"><b>Registered doctors by hospital</b></td></tr>
                @foreach ($doctor_by_hospital as $doctor)
                <tr>
                    <td>{{ucfirst($doctor['hospital'])}}</td>
                    <td>{{$doctor['cnt']}}</td>
                </tr>
                @endforeach

                <tr><td colspan="2"><b>Registered doctors by gender</b></td></tr>
                @foreach ($doctor_by_gender as $doctor)
                <tr>
                ...
                <tr><td colspan="2"><b>Registered doctors by venue</b></td></tr>
                @foreach ($doctor_by_venue as $doctor)
                <tr>
                    <td>{{ucfirst($doctor['venue'])}}</td>
                    <td>{{$doctor['cnt']}}</td>
                </tr>
                @endforeach
